...
function showBtns() {
    (mode == MODE_REPLAY && ($("#mode1").hide(), $("#mode3").hide(), $("#mode2").show()) ,
	mode == MODE_PLAY && ($("#mode2").hide(), $("#mode3").hide(),$("#mode1").show()) ,
	mode == MODE_BILL && ($("#mode1").hide(),$("#noteBtn").hide(),$("#sendBtn2").hide(),$("#mode4").show())),
    $("#btnBox").show()
}
...
comm.onload = function() {
    ...
    $("#moreBtn1").click(moreBtn),
    $("#moreBtn2").click(moreBtn),
    $("#moreBtn3").click(moreBtn),
	$("#moreBtn4").click(moreBtn),
	$("#prevBtn2").click(bill.replayPrev),
    $("#nextBtn2").click(bill.replayNext),
    $("#moreBtn").click(moreBtn),
...
comm.send = function(e) {
	...
	$.ajax({
		...
		success: function(response,status,xhr) {
			console.log(_json);
			var href = baseURL+'index.html?file='+comm.filename;	
